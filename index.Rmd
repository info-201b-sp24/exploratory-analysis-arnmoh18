...
```{r table, echo=FALSE}
source("/Users/arnav/Desktop/INFO201/exploratory-analysis-arnmoh18/AggregatedTable.R")
...
Purpose of the chart: This tree map visualizes the total food waste by commodity for the top 4 countries with the most waste. The size of each box represents the total loss of each commodity in each country.
...
```{r chart1, echo=FALSE}
source("/Users/arnav/Desktop/INFO201/exploratory-analysis-arnmoh18/Food_waste_TreeMap.R")
...
```{r chart2, echo=FALSE}
source("/Users/arnav/Desktop/INFO201/exploratory-analysis-arnmoh18/Line Plot Food Waste.R")
